...
public:
    ...
    virtual bool getAlarmSystemState();
    virtual void stopCountdownAlarmSet();

    virtual void activateOngoingAlarm();

    virtual bool getCountdownAlarmSetState();
    virtual bool getCountdownOngoingAlarmSetState();
    virtual int countdownAlarmSetTick();
    virtual int countdownOngoingAlarmSetTick();
